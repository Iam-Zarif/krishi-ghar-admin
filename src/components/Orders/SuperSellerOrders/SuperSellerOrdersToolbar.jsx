...
import { SORT_OPTIONS, STATUS_TABS } from "./supersellerOrderHelpers";
  ...
  <div className="rounded-lg bg-white px-6 py-5 shadow-md">
    ...
    <div className="mt-5 flex flex-col gap-3 lg:flex-row">
      <div className="relative flex-1">
        <input
          type="text"
          placeholder="Search by product, supersaler, location, status..."
          value={search}
      ...
      <select
        ...
        className="cursor-pointer rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-semibold text-gray-700 shadow-sm focus:outline-green-500 lg:w-56"
      >
