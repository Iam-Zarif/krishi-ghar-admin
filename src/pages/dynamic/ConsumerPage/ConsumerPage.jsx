      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="flex flex-col items-start md:w-1/3 gap-y-3">
          ...
          <p className="text-gray-600 flex items-center gap-2">
            <FaEnvelope className="text-blue-500" /> {consumer.email}
          </p>
          <p className="text-gray-600 flex items-center gap-2">
            <FaPhone className="text-green-500" />
            <span className="font-bold">Phone:</span> {consumer.phone}
          </p>
          <p className="text-gray-600 flex items-center gap-2">
            <FaMapMarkerAlt className="text-red-500" />
            <span className="font-bold">Address:</span> {consumer.address}
          </p>
          <p className="text-gray-600 flex items-center gap-2">
            <FaShoppingCart className="text-yellow-500" />
            <span className="font-bold">Total Purchases:</span>
            {consumer.totalPurchases} kg
          </p>
          <p className="text-gray-600 flex items-center gap-2">
          ...
          <p className="text-gray-600 flex items-center gap-2">
            ...
            <span className="font-bold">Last Login:</span> {consumer.lastLogin}
          </p>
        </div>
